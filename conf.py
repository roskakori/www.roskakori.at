...
BLOG_AUTHOR = "Thomas Aglassinger"  # (translatable)
BLOG_TITLE = "Thomas Aglassinger's Homepage"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.roskakori.at/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.roskakori.at/"
BLOG_EMAIL = "roskakori@users.sourceforge.net"
BLOG_DESCRIPTION = "Projects, talks and publications of Thomas Aglassinger"  # (translatable)
